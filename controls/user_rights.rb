...
control 'cis-synchronize-dc-data-2.2.39' do
  impact 0.7
  title '2.2.39 Ensure Synchronize directory service data is set to No One'
  desc 'Ensure Synchronize directory service data is set to No One'

  tag cis: ['windows_2012r2:2.2.39']
  ref 'CIS Microsoft Windows Server 2012 R2 Benchmark'

  #TODO domain controller only
end
